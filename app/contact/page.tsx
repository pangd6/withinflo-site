...
import { Zap, Linkedin, Send } from "lucide-react"
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8 bg-[#EEE5E9]">
        <Card className="w-full max-w-md bg-[#EEE5E9] border border-[#38686A]/20">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-[#38686A]">Contact Us</CardTitle>
            <CardDescription>Have questions or feedback? We'd love to hear from you.</CardDescription>
          </CardHeader>
          <CardContent>
            {isSuccess ? (
              <div className="text-center space-y-4">
                <div className="text-xl font-medium text-primary">Thank you for your message!</div>
                <p className="text-[#38686A]">We'll get back to you as soon as possible.</p>
                <Link href="/">
              ...
              <form className="space-y-4" action={handleSubmit}>
                <div className="space-y-2">
                  ...
                  <Input id="name" name="name" placeholder="Enter your name" required className="bg-[#EEE5E9]" />
                </div>
                <div className="space-y-2">
                  <label
                    htmlFor="email"
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-[120px] bg-[#EEE5E9]"
                    required
                  />
                </div>
